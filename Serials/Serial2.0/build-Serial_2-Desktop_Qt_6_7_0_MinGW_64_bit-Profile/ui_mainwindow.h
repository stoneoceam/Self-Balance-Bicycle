...
public:
    ...
    QLineEdit *lineEdit_PortDescription;
    QWidget *widget_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget_7->setMinimumSize(QSize(190, 320));
        widget_7->setMaximumSize(QSize(190, 320));
        ...
        comboBox_PortNumber->setMinimumSize(QSize(80, 0));
        ...
        lineEdit_PortDescription = new QLineEdit(widget_7);
        lineEdit_PortDescription->setObjectName("lineEdit_PortDescription");
        lineEdit_PortDescription->setReadOnly(true);

        verticalLayout->addWidget(lineEdit_PortDescription);
